...
$Monitoring::GLPlugin::SNMP::MibsAndOids::mibs_and_oids->{'PDU2-MIB'} = {
  ...
  'firstNTPServerAddressDefinition' => 'INET-ADDRESS-MIB::InetAddress(firstNTPServerAddressType)',
  ...
  'secondNTPServerAddressDefinition' => 'INET-ADDRESS-MIB::InetAddress(secondNTPServerAddressType)',
  ...
  'activeDNSServerAddressDefinition' => 'INET-ADDRESS-MIB::InetAddress(activeDNSServerAddressType)',
  ...
  'activeNTPServerAddressDefinition' => 'INET-ADDRESS-MIB::InetAddress(activeNTPServerAddressType)',
